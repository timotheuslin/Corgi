...
$MainForm = GUICreate("", 1009, 633, -1, -1, BitOR($GUI_SS_DEFAULT_GUI,$WS_MAXIMIZEBOX,$WS_SIZEBOX,$WS_THICKFRAME,$WS_TABSTOP), BitOR($WS_EX_ACCEPTFILES,$WS_EX_WINDOWEDGE))
$Group1 = GUICtrlCreateGroup("", 120, 0, 497, 150)
$Input2 = GUICtrlCreateInput("", 208, 12, 402, 21, $GUI_SS_DEFAULT_INPUT)
$Input3 = GUICtrlCreateInput("", 208, 39, 402, 21, $GUI_SS_DEFAULT_INPUT)
$Input4 = GUICtrlCreateInput("", 208, 66, 402, 21, $GUI_SS_DEFAULT_INPUT)
$Input5 = GUICtrlCreateInput("", 208, 93, 402, 21, $GUI_SS_DEFAULT_INPUT)
...
$Input1 = GUICtrlCreateInput("", 208, 120, 300, 21, $GUI_SS_DEFAULT_INPUT)
$Label1 = GUICtrlCreateLabel("Version:", 517, 124, 42, 17, 0)
